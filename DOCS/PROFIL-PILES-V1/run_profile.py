...
root=pathlib.Path(sys.argv[1]) if len(sys.argv)>1 else pathlib.Path('DOCS/PROFIL-PILES-V1')
...
args=types.SimpleNamespace(verbose=False,hdv=pt.HDV_SRC,port=6526,speed=200000,pom2='/tmp/scoswamp-stack-pom2/build/POM2',keep=False)
